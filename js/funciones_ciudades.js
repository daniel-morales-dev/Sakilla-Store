...
function ciudades() {
	...
	// 	var datos = $('#f-ciudad').serialize();

	// 	$.ajax({

	// 		type: 'get',
	// 		url: './ciudades/controlador_ciudades.php?accion=editar',
	// 		data: datos,
	// 		dataType: 'json'
	...
	$('#contenido').on('click','button#nuevo',function() {
		...
		$('#nuevo-editar').load('./ciudades/nuevo_ciudad.php');
	...
	// 		type: 'get',
	// 		url: './ciudades/controlador_ciudades.php?accion=nuevo',
	// 		data: datos,
	// 		dataType: 'json'
	...
	$('#contenido').on('click','a.editar',function() {
		...
		$('#nuevo-editar').load('./ciudades/editar_ciudad.php');
		$('#nuevo-editar').removeClass('d-none');
		$('#ciudades').addClass('d-none');
		...
		$.ajax({
			...
			$.each(e.data, function(index, value) {
				...
				if (pais === value.id) {
					...
					$('#pais').append('<option selected value="' + value.id + '">' + value.pais + "</option>")
...
$(document).ready(() => {
	...
	dt = $('#tabla').DataTable({
		...
		'ajax': './ciudades/controlador_ciudades.php/?accion=listar',
		'columns': [
			{'data': 'id'},
			{'data': 'ciudad'},
			{'data': 'pais'},

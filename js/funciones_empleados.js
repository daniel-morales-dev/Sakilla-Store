...
function empleados() {
	...
	// 	var datos = $('#nombre, #apellido, #email, #usuario, #clave, #rol, #tienda, #activo').serialize();
	// 	var datos_direccion = $('#direccion, #distrito, #cod_postal, #telefono').serialize();
	...
	// 			type: 'get',
	// 			url: './empleados/controlador_empleados.php?accion=editar',
	// 			data: datos,
	// 			dataType: 'json'
	...
	// 		url = './empleados/controlador_empleados.php?accion=nuevo&direccion='+e.id_dir
	...
	$('#contenido').on('click','a.editar',function() {
		...
		$('#nuevo-editar').load('./empleados/editar_empleado.php');
		$('#nuevo-editar').removeClass('d-none');
		$('#empleados').addClass('d-none');
		...
		$.ajax({
			...
			if (e.respuesta === "no existe") {
				...
				// $('#clave').val(e.clave);
				$('#rol'+e.rol).attr("selected","selected");
				tienda = e.tienda;
				id_dir = e.direccion;
...
function actualizar() {
	var datos = $('#id, #nombre, #apellido, #email, #usuario, #clave, #rol, #tienda, #estado').serialize();
...
$(document).ready(() => {
	...
	dt = $('#tabla').DataTable({
		...
		'ajax': './empleados/controlador_empleados.php/?accion=listar',
		'columns': [
			{'data': 'id'},
			{'data': 'nombre'},
			{'data': 'direccion'},
